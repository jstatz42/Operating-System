...
DEVICE_OBJS=objects/pic.o objects/keyboard.o objects/pit.o
...
PIT=devices/pit/pit.c

.PHONY: all clean qemu debug

all: pit.o stack.o keyboard.o pic.o io.o interC.o interrupts.o paging.o asmgdt.o gdt.o string.o crti.o crtn.o vga.o kernel.o boot.o myos.iso

pit.o: $(PIT)
	$(CC) -c $(PIT) -o objects/pit.o $(CFLAGS)
